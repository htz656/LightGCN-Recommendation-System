...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='./datasets/hetrec2011-lastfm-2k',
    ...
    parser.add_argument('--device', type=str, default='cpu',
                        choices=['cpu', 'cuda:0'], help='Learning rate')
    ...
    parser.add_argument('--topN', nargs='+', type=int, default=[5, 10, 20],
